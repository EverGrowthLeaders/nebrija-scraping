export const CAMPAIGN_LEAD_EXPORT_COLUMNS = [
  ...
  { key: "decision_maker_name", label: "Decisor" },
  ...
  { key: "ads_funnel_type", label: "Tipo funnel Ads" },
  { key: "ads_funnel_confidence", label: "Confianza funnel Ads", type: "number" },
  { key: "ads_funnel_landing_url", label: "Landing clasificada" },
  { key: "ads_funnel_last_checked_at", label: "Funnel Ads revisado" },
